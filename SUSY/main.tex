...
\begin{titlepage}
	\centering
	    ...
	    {\scshape\Large Dr. Stefano Cremonesi} % Lecturer Name
...
These are my notes on the 2020 lecture course "Supersymmetry" taught by Dr. Stefano Cremonesi at Durham University as part of the Particles, Strings and Cosmology Msc. For reference, the course lasted 16 hours and was taught over 4 weeks. \\
...
I would like to extend a message of thanks to Dr. Cremonesi for teaching this course. I would also like to thank Thimo Preis for helping getting these notes started.\\
...
These notes are not endorsed by Dr. Cremonesi or Durham University.
...
\input{sections/01Review.tex}
\input{sections/02SuperAlgebra.tex}
\input{sections/03Superspace.tex}
\input{sections/04SQFTChiral.tex}
\input{sections/05Gauge.tex}
\input{sections/06Spontaneous.tex}
